<script>
$(document).ready(pagination(1));puesto();empresa();servicio();pagination_jornada_colaboradores(1);pagination_servicio(1);pagination_puestos(1);puestoServcioColaborador();getJornadaColaborador();getEstatus();getServicioAsignacion();paginationAsignacionServiciosColaboradores(1);
  $(function(){
