...
$objPHPExcel->getActiveSheet()->setTitle("Reporte Atenciones Colposcopía"); //establecer titulo de hoja
...
$fila=1;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A3:Z3");
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", $empresa_nombre);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:Z$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:Z$fila");

$fila=2;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A4:Z4");
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Atenciones Colposcopía");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:Z$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:Z$fila");

$fila=3;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A5:Z5");
...
$objPHPExcel->getActiveSheet()->SetCellValue("M$fila", 'Test VPH');
$objPHPExcel->getActiveSheet()->getColumnDimension('M')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("M4:M5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("N$fila", 'Resultado Citología');
...
$objPHPExcel->getActiveSheet()->SetCellValue("P$fila", 'Evaluación General');
$objPHPExcel->getActiveSheet()->getColumnDimension('P')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("P4:P5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("Q$fila", 'Zona de Transformación');
$objPHPExcel->getActiveSheet()->getColumnDimension('Q')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("Q4:Q5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("R$fila", 'Hallzgos');
$objPHPExcel->getActiveSheet()->getColumnDimension('R')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("R4:R5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("S$fila", 'Biopsia');
$objPHPExcel->getActiveSheet()->getColumnDimension('S')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("S4:S5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("T$fila", 'ECC');
$objPHPExcel->getActiveSheet()->getColumnDimension('T')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("T4:T5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("U$fila", 'Test Shiller');
$objPHPExcel->getActiveSheet()->getColumnDimension('U')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("U4:U5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("V$fila", 'Observaciones 1');
$objPHPExcel->getActiveSheet()->getColumnDimension('V')->setWidth(40);
$objPHPExcel->getActiveSheet()->mergeCells("V4:V5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("W$fila", 'Resultados Biopsia');
$objPHPExcel->getActiveSheet()->getColumnDimension('W')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("W4:W5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("X$fila", 'Tratamiento');
$objPHPExcel->getActiveSheet()->getColumnDimension('X')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("X4:X5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("Y$fila", 'Seguimiento');
$objPHPExcel->getActiveSheet()->getColumnDimension('Y')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("Y4:Y5"); //unir celdas
$objPHPExcel->getActiveSheet()->SetCellValue("Z$fila", 'Atención');
$objPHPExcel->getActiveSheet()->getColumnDimension('ZI')->setWidth(20);
$objPHPExcel->getActiveSheet()->mergeCells("Z4:Z5"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "A$fila:Z$fila"); //establecer estilo
$objPHPExcel->getActiveSheet()->getStyle("A$fila:Z$fila")->getFont()->setBold(true); //negrita
...
if($result->num_rows>0){
	while($registro2 = $result->fetch_assoc()){
     ...
     $objPHPExcel->getActiveSheet()->SetCellValue("M$fila", $registro2['test_vph']);
     $objPHPExcel->getActiveSheet()->SetCellValue("N$fila", $registro2['resultado_citologia']);
     $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", $registro2['observaciones']);
     $objPHPExcel->getActiveSheet()->SetCellValue("P$fila", $registro2['evaluacion_general']);
     $objPHPExcel->getActiveSheet()->SetCellValue("Q$fila", $registro2['zona_transformacion']);
     $objPHPExcel->getActiveSheet()->SetCellValue("R$fila", $registro2['hallazgos']);
     $objPHPExcel->getActiveSheet()->SetCellValue("S$fila", $registro2['biopsia']);
     $objPHPExcel->getActiveSheet()->SetCellValue("T$fila", $registro2['ecc']);
     $objPHPExcel->getActiveSheet()->SetCellValue("U$fila", $registro2['test_schiller']);
     $objPHPExcel->getActiveSheet()->SetCellValue("V$fila", $registro2['observaciones1']);
     $objPHPExcel->getActiveSheet()->SetCellValue("W$fila", $registro2['resultados_biopsia']);
     $objPHPExcel->getActiveSheet()->SetCellValue("X$fila", $registro2['tratamiento']);
     $objPHPExcel->getActiveSheet()->SetCellValue("Y$fila", $registro2['seguimiento']);     
	   ...
	   $objPHPExcel->getActiveSheet()->SetCellValue("Z$fila", $atencion);	   
	   
    //Establecer estilo
    $objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A$fila:Z$fila");	
	  $valor++;
   }	
}
...
// nombre del archivo
header('Content-Disposition: attachment; filename="Reporte de Atenciones Colposcopia'.$mes.'_'.$año.'.xls"');
//**********************************************************************
