...
while($registro2 = $result->fetch_assoc()){		  
	...
	$tabla = $tabla.'<tr>
		...
		<td>
			<a class="btn btn btn-secondary ml-2" href="javascript:setAtencion('.$registro2['pacientes_id'].','.$registro2['agenda_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-book-medical fa-lg"></i> Atención</a>
			<a class="btn btn btn-secondary ml-2" href="javascript:nosePresentoRegistro('.$registro2['pacientes_id'].','.$registro2['agenda_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-times-circle fa-lg"></i></i> Ausencia</a>
		</td>						
	</tr>';	
	$i++;				
}
