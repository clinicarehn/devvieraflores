...
$tabla = $tabla.'<table class="table table-striped table-condensed table-hover">
		  <tr>
			<th width="1.33%">N°</th>
			<th width="7.33%">Identidad</th>
			<th width="21.33%">Nombre</th>
			<th width="6.33%">Fecha Cita</th>
			<th width="7.33%">Hora</th>	
			<th width="8.33%">Usuario</th>				
			<th width="10.33%">Profesional</th>
			<th width="6.33%">Teléfono</th>
			<th width="12.33%">Observación</th>
			<th width="12.33%">Comentario</th>	
			<th width="2.33%">Usuario</th>				
	   ...
	   <td>   
			<div class="dropdown show">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="javascript:editarRegistro('.$registro2['agenda_id'].','.$registro2['colaborador_id'].','.$registro2['pacientes_id'].','.$registro2['servicio_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</a>
					<a class="dropdown-item" href="javascript:reportePDF('.$registro2['agenda_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-print fa-lg"></i> Imprimir action</a>
					<a class="dropdown-item" href="javascript:modal_eliminar('.$registro2['agenda_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-trash fa-lg"></i> Eliminar</a>
					<a class="dropdown-item" href="javascript:nosePresentoRegistro('.$registro2['agenda_id'].','.$registro2['pacientes_id'].','.$registro2['fecha'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-times-circle fa-lg"></i> Marcar Ausencia</a>
				</div>
			</div>
	   </td>
  </tr>';		
