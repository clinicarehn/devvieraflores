...
while($registro2 = $result->fetch_assoc()){	
	$tabla = $tabla.'<tr>
	   <td><a style="text-decoration:none" title = "Información de Usuario" href="javascript:showData('.$registro2['eco_obstetrica_id'].');">'.$registro2['fecha'].'</a></td>
	   <td>'.$registro2['usuario'].'</td>		   
	   <td>'.$registro2['identidad'].'</td>	
       <td>'.$registro2['genero'].'</td>	
       <td>'.$registro2['paciente'].'</td>		   
	   <td>'.$registro2['edad'].'</td>
	   <td>'.$registro2['unico'].'</td>		   
	   <td>'.$registro2['multiple'].'</td>
	   <td>'.$registro2['longitudinal'].'</td>
	   <td>'.$registro2['transverso'].'</td>		   
	   <td>'.$registro2['cefalica'].'</td>	
       <td>'.$registro2['podalica'].'</td>	
       <td>'.$registro2['izquierda'].'</td>		   
	   <td>'.$registro2['derecha'].'</td>
	   <td>'.$registro2['posterior'].'</td>		   
	   <td>'.$registro2['anterior'].'</td>   
	</tr>';	        
}
