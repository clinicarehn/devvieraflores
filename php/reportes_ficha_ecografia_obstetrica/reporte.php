...
$objPHPExcel->getActiveSheet()->setTitle("Reporte Atenciones Obstetrica"); //establecer titulo de hoja
...
$fila=1;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A3:AR3");
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", $empresa_nombre);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AR$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AR$fila");

$fila=2;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A4:AR4");
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Atenciones Ecografía Obstétrica");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AR$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AR$fila");

$fila=3;
$objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A5:AR5");
...
if($result->num_rows>0){
	while($registro2 = $result->fetch_assoc()){
     ...
     $objPHPExcel->getActiveSheet()->SetCellValue("M$fila", $registro2['unico']);
     $objPHPExcel->getActiveSheet()->SetCellValue("N$fila", $registro2['multiple']);
     $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", $registro2['longitudinal']);
     $objPHPExcel->getActiveSheet()->SetCellValue("P$fila", $registro2['transverso']);
     $objPHPExcel->getActiveSheet()->SetCellValue("Q$fila", $registro2['cefalica']);
     $objPHPExcel->getActiveSheet()->SetCellValue("R$fila", $registro2['podalica']);
     $objPHPExcel->getActiveSheet()->SetCellValue("S$fila", $registro2['izquierda']);
     $objPHPExcel->getActiveSheet()->SetCellValue("T$fila", $registro2['derecha']);
     $objPHPExcel->getActiveSheet()->SetCellValue("U$fila", $registro2['posterior']);
     $objPHPExcel->getActiveSheet()->SetCellValue("V$fila", $registro2['anterior']);
     $objPHPExcel->getActiveSheet()->SetCellValue("W$fila", $registro2['sg']);
     $objPHPExcel->getActiveSheet()->SetCellValue("X$fila", $registro2['cc']);
     $objPHPExcel->getActiveSheet()->SetCellValue("Y$fila", $registro2['lcn']);
     $objPHPExcel->getActiveSheet()->SetCellValue("Z$fila", $registro2['ca']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AA$fila", $registro2['dbp']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AB$fila", $registro2['lf']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AC$fila", $registro2['ponderado_fetal']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AD$fila", $registro2['fcf']);      
     $objPHPExcel->getActiveSheet()->SetCellValue("AE$fila", $registro2['placenta_anterior']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AF$fila", $registro2['placenta_posterior']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AG$fila", $registro2['placenta_fundica']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AH$fila", $registro2['placenta_previa']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AI$fila", $registro2['gradoi']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AJ$fila", $registro2['gradoii']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AK$fila", $registro2['gradoiii']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AL$fila", $registro2['circular']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AM$fila", $registro2['liquido_amniotico']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AN$fila", $registro2['fecha_parto']);     
     $objPHPExcel->getActiveSheet()->SetCellValue("AO$fila", $registro2['malformacion']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AP$fila", $registro2['sexo']);
     $objPHPExcel->getActiveSheet()->SetCellValue("AQ$fila", $registro2['conclusion']);     
	   ...
	   $objPHPExcel->getActiveSheet()->SetCellValue("AR$fila", $atencion);	   
	   
    //Establecer estilo
    $objPHPExcel->getActiveSheet()->setSharedStyle($bordes, "A$fila:AR$fila");	
	  $valor++;
   }	
}
...
// nombre del archivo
header('Content-Disposition: attachment; filename="Reporte de Atenciones Ecografia Obstetrica'.$mes.'_'.$año.'.xls"');
//**********************************************************************
