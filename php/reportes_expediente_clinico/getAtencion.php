...
if($result->num_rows>0){
	...
	$datos = "
		...
		<div class='form-row'>
			<div class='col-md-12 mb-6 sm-3'>
				<p style='color: #077A2F;' align='center'><b>Historia Ginecostetrica</b></p>
			</div>					
		</div>	
		<div class='form-row'>
		...
		<div class='form-row'>					
			...
			<div class='col-md-3 mb-3 sm-3'>
				<p><b>Ciclos Menstruales:</b> $ciclos_menstruales_aten</p>
			</div>	
			<div class='col-md-3 mb-3 sm-3'>
		...
		<div class='form-row'>
			<div class='col-md-12 mb-3'>
				<p><b>Antecedentes Patologicos Personales:</b> $antec_personales_aten</p>
			</div>
			<div class='col-md-12 mb-3'>
				<p><b>Antecedentes Patologicos Familiares:</b> $ante_familiares_anten</p>
			</div>
			<div class='col-md-12 mb-3'>
